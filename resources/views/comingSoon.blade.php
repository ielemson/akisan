    ...
    <div class="loader">
      <div class="loader__content">
        <div class="loader__logo fadeIn">
          <!-- Your Logo Here -->
          <img src="{{ asset('assets/images/logo/akisan-logo-white.png')}}" alt="akisan coming soon">
        </div>
      </div>
    </div>
    <!-- Loader End-->
            ...
            <div class="main__header">
              <div class="header__container">
                <div class="header__content">
                  <!-- logo -->
                  <div class="logo">
                    <img src="{{ asset('assets/images/logo/akisan-logo-white.png')}}" style="width:50%; height:auto">
                  </div>
                  <!-- menu trigger -->
            ...
            <div class="main__headline">
              <div class="headline__content">
                ...
                <div class="headline__btnholder loading-el loading-el-4">
                  <a href="{{url('/')}}" class="btn btn-solid">
