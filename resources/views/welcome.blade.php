...
<div class="site-wrapper-reveal">
    ...
    <div
      class="appointment-hero-wrapper appointment-hero-bg section-space--ptb_120"
    >
      <div class="container">
              ...
              <form  method="POST" action="{{ route('appointment.store') }}">
                ...
                <div class="contact-form__two">
                  <div class="contact-inner">
                    <input  type="text" placeholder="Name *" class="form-control {{ $errors->has('subject') ? 'error' : '' }}" name="name"
                    id="name"/>
                    @if ($errors->has('name'))
                    <div class="error">
                        {{ $errors->first('name') }}
                  ...
                  <div class="contact-inner">
                    <input  type="email" placeholder="Email *" class="form-control {{ $errors->has('subject') ? 'error' : '' }}" name="email"
                    id="email"/>
                    @if ($errors->has('email'))
                    <div class="error">
                        {{ $errors->first('email') }}
                  ...
                  <div class="contact-select">
                    <div class="form-item contact-inner">
                      <span class="inquiry">
                        <select class="select-item" class="form-control {{ $errors->has('subject') ? 'error' : '' }}" name="inquiry"
                          id="inquiry">
                          <option value="">
                            Your inquiry about
                          </option>
    ...
    <div class="tabs-wrapper bg-gray section-space--ptb_100">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div
              class="section-title-wrapper text-center section-space--mb_60 wow move-up"
            >
        ...
        <div class="row">
          <div class="col-lg-12 ht-tab-wrap">
            <div class="text-center">
              <ul
                class="nav justify-content-center ht-tab-menu ht-tab-menu_two"
                role="tablist"
              >
                        ...
                        <div class="large-image-box">
                          <div class="box-image">
                            <div class="default-image">
                              <img
                                class="img-fluid"
                                src="assets/images/box-image/blog-01-480x298.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                        ...
                        <div class="large-image-box">
                          <div class="box-image">
                            <div class="default-image">
                              <img
                                class="img-fluid"
                                src="assets/images/box-image/Akisan Tech&#174;-home-infotechno-box-large-image-03-480x298.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                        ...
                        <div class="large-image-box">
                          <div class="box-image">
                            <div class="default-image">
                              <img
                                class="img-fluid"
                                src="assets/images/box-image/Akisan Tech&#174;-home-infotechno-box-large-image-02-480x298.jpg"
                                alt=""
                              />
                            </div>
                          </div>
    ...
    <div
      class="team-member-wrapper section-space--pt_100 section-space--pb_40"
    >
      <!-- <div class="container">
        <div class="row">
          <div class="col-lg-4">
