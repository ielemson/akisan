...
<span class="inquiry">
<select class="select-item" name="inquiry"
id="inquiry" required>
<option value="">
Your inquiry about
</option>
...
<a href="{{ url('contact-us')}}" class="ht-btn ht-btn-md ht-btn--outline"
>Contact us now
</a>
</div>
</div>
...
<img
class="img-fluid"
src="assets/images/bg/team-work.png"
alt=""
/>
<div class="ht-popup-video video-button">
<div class="video-mark">
...
Let's talk</a
>
<a href="{{ url('contact-us')}}" class="btn btn--secondary btn-two"
><span class="btn-icon mr-2"
